...
namespace mytodolist.Services.Implementations
{
    public class TokenService : ITokenService
    {
        ...
        public string GenarateAccessToken(IEnumerable<Claim> claims)
        {
            ...
            var signingCredentiails = new SigningCredentials(secretKey, SecurityAlgorithms.HmacSha256);
            var options = new JwtSecurityToken(
                issuer : _configuration.Issuer,
                audience : _configuration.Audience,
                claims : claims,
                expires : DateTime.Now.AddMinutes(_configuration.Minutes),
                signingCredentials : signingCredentiails
